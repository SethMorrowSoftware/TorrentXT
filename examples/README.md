...
| `newquickshare.livecodescript` | The **same** Quick Share, re-skinned: a wider, shorter, **720p-friendly** two-column dashboard with a plain-English 3-way "how to share" choice (Share code / Private-Tor / Web link), numbered steps, and Receive / Transfers / Activity grouped on the right. Same engine and features as `torrent-quickshare`. | Only for the optional passphrase lock |
